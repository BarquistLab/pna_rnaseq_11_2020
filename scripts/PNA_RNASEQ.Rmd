...
#geo <- GenewiseCounts
#colnames(geo) <- gsub("\\.\\.\\.data\\.rna_align\\.(.*_S\\d\\d?_R1_001)\\.bam", "\\1", 
#                                 colnames(geo))
#colnames(geo) <- gsub("ID\\.", "ID-", 
#                                 colnames(geo))
#write.csv(geo, "../data/GEO/counttable.csv")
